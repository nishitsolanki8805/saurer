          ...
          <ul className="metismenu list-unstyled" id="side-menu">
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/practice" className="waves-effect">
                    <span className="ms-1">{this.props.t("Practice Tab")}</span>
                  </Link>
                </li>
              </ul>
            </li> */}
            ...
            <li>
              <Link to="/dashboard" className="waves-effect">
                ...
                <span
                  className="ms-1"
                  style={{ color: "#000", fontWeight: "800", fontSize: 16 }}
                >
            ...
            <li>
              <Link
                to="/#"
                style={{ color: `var(--bs-header-bg`, fontSize: 16 }}
              ...
              <ul className="sub-menu">
                <li>
                  <Link
                    to={process.env.PUBLIC_URL + "/rolelist"}
                ...
                {/* <li>
                  <Link
                    to={process.env.PUBLIC_URL + "/permission-list"}
                    className="waves-effect"
                  >
                    <span
                      style={{ color: "#000", fontWeight: "600" }}
                      className="ms-1"
                    >
                      {this.props.t("Permission Management")}
                    </span>
                  </Link>
                </li> */}
                <li>
                  <Link
                    //  to="/theme"
                    to={process.env.PUBLIC_URL + "/theme"}
                    className="waves-effect"
                  >
                    <span
                      style={{ color: "#000", fontWeight: "600" }}
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link
                    to={process.env.PUBLIC_URL + "/designation-list"}
                    className="waves-effect"
                  >
                    <span
                      style={{ color: "#000", fontWeight: "600" }}
                ...
                <li>
                  <Link
                    to={process.env.PUBLIC_URL + "/process-list"}
                    className="waves-effect"
                  >
                    <span
                      style={{ color: "#000", fontWeight: "600" }}
                ...
                <li>
                  <Link
                    to={process.env.PUBLIC_URL + "/process-line-list"}
                    className="waves-effect"
                  >
                    <span
                      style={{ color: "#000", fontWeight: "600" }}
                      className="ms-1"
                    >
                      {this.props.t("Process Line")}
                    </span>
                  </Link>
                </li>
                <li>
                  <Link
                    to={process.env.PUBLIC_URL + "/production-enduse-list"}
                    className="waves-effect"
                  >
                    <span
                      style={{ color: "#000", fontWeight: "600" }}
                      className="ms-1"
                    >
                      {this.props.t("Production Enduse")}
                    </span>
                  </Link>
                </li>
                ...
                <li>
                  <Link
                    to={process.env.PUBLIC_URL + "/install-base-make"}
                    className="waves-effect"
                  >
                    <span
                      style={{ color: "#000", fontWeight: "600" }}
                      className="ms-1"
                    >
                      {this.props.t("Install Base Make")}
                    </span>
                  </Link>
                </li>
                ...
                <li>
                  <Link
                    to={process.env.PUBLIC_URL + "/install-base-modal"}
                    className="waves-effect"
                  >
                    <span
                      style={{ color: "#000", fontWeight: "600" }}
                      className="ms-1"
                    >
                      {this.props.t("Install Base Modal")}
                    </span>
                  </Link>
                </li>
                <li>
                  <Link
                    to={process.env.PUBLIC_URL + "/install-base-type"}
                    className="waves-effect"
                  >
                    <span
                      style={{ color: "#000", fontWeight: "600" }}
                      className="ms-1"
                    >
                      {this.props.t("Install Base Type")}
                    </span>
                  </Link>
                </li>
                ...
                <li>
                  <Link
                    to={process.env.PUBLIC_URL + "/filtration-make"}
                    className="waves-effect"
                  >
                    <span
                      style={{ color: "#000", fontWeight: "600" }}
                      className="ms-1"
                    >
                      {this.props.t("Filtration Make")}
                    </span>
                  </Link>
                </li>
                <li>
                  <Link
                    to={process.env.PUBLIC_URL + "/humidification-make"}
                    className="waves-effect"
                  >
                    <span
                      style={{ color: "#000", fontWeight: "600" }}
                      className="ms-1"
                    >
                      {this.props.t("Humidification Make")}
                    </span>
                  </Link>
                </li>
                <li>
                  <Link
                    to={process.env.PUBLIC_URL + "/pneumatic-make"}
                    className="waves-effect"
                  >
                    <span
                      style={{ color: "#000", fontWeight: "600" }}
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link
                    to={process.env.PUBLIC_URL + "/employee-list"}
                    className="waves-effect"
                  >
                    <span
                      style={{ color: "#000", fontWeight: "600" }}
                ...
                <li>
                  <Link
                    to={process.env.PUBLIC_URL + "/supervisor-list"}
                    className="waves-effect"
                  >
                    <span
                      style={{ color: "#000", fontWeight: "600" }}
                ...
                <li>
                  <Link
                    to={process.env.PUBLIC_URL + "/auditor"}
                    className="waves-effect"
                  >
                    <span
                      style={{ color: "#000", fontWeight: "600" }}
            ...
            {/* <li>
              <Link to={"/#"} className=" waves-effect">
                ...
                <span className="ms-1">{this.props.t("Property Master")}</span>
              </Link>
            </li> */}
            {/* <li>
              <Link
                to={process.env.PUBLIC_URL + "/property-list"}
                className=" waves-effect"
              >
                <i style={{color: `var(--bs-header-bg`}} className="ri-building-fill "></i>
                <span  style={{color:"#000",fontWeight:'800',fontSize:16}} className="ms-1">{this.props.t("Property Master")}</span>
              </Link>
            </li> */}
            {/* <li>
              <Link to={ process.env.PUBLIC_URL + "/create-Rental-property"} className=" waves-effect">
                <i className="ri-building-fill "></i>
                <span className="ms-1">{this.props.t("Test Rentals Property")}</span>
              </Link>
            </li> */}

            {/* <li>
              <Link to= {process.env.PUBLIC_URL + "/test-ex"} className=" waves-effect">
                <i className="ri-calendar-2-line"></i>
                <span className="ms-1">{this.props.t("test")}</span>
              </Link>
            </li> */}
            ...
            {/* <li>
              <Link to={"/#"} className=" waves-effect">
                ...
                <span className="ms-1">{this.props.t("Report")}</span>
              </Link>
            </li> */}
