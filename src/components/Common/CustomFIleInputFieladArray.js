...
// class CustomFileInputFieldArray extends Component {
//   constructor(props) {
//     super(props);
//     this.state = {
...
//        this.props.setFieldValue('property_photo_1', base64Data)
...
// export default CustomFileInputFieldArray;
  ...
  handleImageChange = (e) => {
    ...
    if (file) {
      ...
      reader.onload = (event) => {
        ...
        const base64Data = event.target.result;
        // Use this.props.form.setFieldValue instead of this.props.setFieldValue
        this.props.setFieldValue(this.props.name, base64Data);
      };
      reader.readAsDataURL(file);
    }
  };
