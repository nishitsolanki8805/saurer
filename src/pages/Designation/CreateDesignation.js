...
class CreateDesignation extends Component {
  constructor(props) {
    ...
    this.validationSchema = this.props.match.params.id
      ? Yup.object().shape({
        designation_name: Yup.string().required("Enter Designation Name"),
  ...
  async GetUserById(id) {
    ...
    await fetch(GET_DESIGNATION_BY_ID + id, {
      method: "GET",
      headers: {
  ...
  createUser = async (data) => {
    ...
    const Token = JSON.parse(StoredData);
    try {
      const response = await fetch(CREATE_DESIGNATION, {
        method: "POST",
        headers: {
          Authorization: "Bearer " + Token.access_token,
          Accept: "application/json",
  ...
  UpdateUser = async (data) => {
    ...
    const Token = JSON.parse(StoredData);
    try {
      const response = await fetch(UPDATE_DESIGNATION + this.state.dataByID.id, {
        method: "POST",
        headers: {
          Authorization: "Bearer " + Token.access_token,
          Accept: "application/json",
              ...
              <Card>
                <CardBody>
                  <Formik
                    ...
                    initialValues={{
                      designation_name: this.state.isEdit
                        ? this.state.dataByID.designation_name
                        : "",
