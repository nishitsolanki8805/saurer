...
import { GET_ALL_EXPENSE, GET_ALL_USER } from "../../../global";
                ...
                <td style={{ width: "90px" }} className="text-center">
                    <>
                        <AiTwotoneEdit
                            ...
                            onClick={() =>
                                history.push(process.env.PUBLIC_URL + '/edit-expanse/' + item.id, { isView: false, page: currentpageIndex, perPage: perPage })
                            }
                        />
                        {/* <ImEye
                                    style={{
        ...
        <React.Fragment>
            <div className="page-content">
                <Container fluid={true}>
                    <Breadcrumbs title="Expense List" breadcrumbItems={breadcrumbItems} />
                    {isLoading ? (
                        <>
                            {/* <ThreeDots
                height="80"
