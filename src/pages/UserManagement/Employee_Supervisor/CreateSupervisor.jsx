...
class CreateSupervisor extends Component {
    ...
    this.state = {
      breadcrumbItems: [
        ...
        },
        {
          ...
          link: process.env.PUBLIC_URL + "/supervisor-list",
        },
        {
          title: this.props.match.params.id ? "Edit Supervisor" : "Create Supervisor",
          link: "#",
        },
      ],
      isProfileBase64URL: "",
  ...
  UpdateUser = async (data) => {
    ...
    try {
      ...
      // Handle successful response
      if (response.status === 200) {
        toast("Update Supervisor Successfully", {
          type: "success",
        });
        this.props.history.goBack();
      } else {
                ...
                <CardBody>
                  <Formik
                    ...
                    onSubmit={(values, { resetForm }) => {
                      const updatedValue = {
                        ...values,
                        role_id_encode: "aYOxlpzRMwrX3gD7",
                        designation_id_encode: "aYOxlpzRMwrX3gD7",
                        department_id_encode: "aYOxlpzRMwrX3gD7",
