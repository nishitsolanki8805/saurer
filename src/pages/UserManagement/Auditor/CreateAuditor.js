...
class CreateAuditor extends Component {
  constructor(props) {
    super(props);
    this.state = {
      breadcrumbItems: [
        ...
        {
          title: "Auditor List",
          link: process.env.PUBLIC_URL + "/auditor",
        },
        {
          title: this.props.match.params.id ? "Edit Auditor" : "Create Auditor",
          link: "#",
        },
      ],
      isProfileBase64URL: "",
  ...
  UpdateUser = async (data) => {
    ...
    try {
      ...
      // Handle successful response
      if (response.status === 200) {
        toast("Update Auditor  Successfully", {
          type: "success",
        });
        this.props.history.goBack();
      } else {
              ...
              <Card>
                <CardBody>
                  <Formik
                    ...
                    initialValues={{
                      middle_name: this.state.isEdit ? this.state.dataByID.middle_name : "",
                    ...
                    onSubmit={(values, { resetForm }) => {
                      const updatedValue = {
                        ...values,
                        ...values,
                        role_id_encode: "39n0Z12OZGKERJgW",
                        designation_id_encode: "39n0Z12OZGKERJgW",
                        department_id_encode: "39n0Z12OZGKERJgW",
